    ...
    extend: {
      colors: {
        ...
        aquamarine: {
          ...
          foreground: "hsl(var(--aquamarine-foreground))",
        },
        flame: {
        ...
        chart: {
          youtube: "hsl(var(--chart-youtube))",
          tiktok: "hsl(var(--chart-tiktok))",
          instagram: "hsl(var(--chart-instagram))",
          rumble: "hsl(var(--chart-rumble))",
          spotify: "hsl(var(--chart-spotify))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "50%": { boxShadow: "0 0 30px hsl(var(--primary) / 0.5), 0 0 40px hsl(var(--secondary) / 0.3)" }
        },
        "float": {
